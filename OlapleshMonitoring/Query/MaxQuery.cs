...
{
    public partial class MaxQuery : Form
    {
        ...
        private void MaxQuery_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("SELECT * FROM Emission WHERE count = (SELECT MAX(count) FROM Emission)", sqlConnection);
